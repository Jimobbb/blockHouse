<template>
    <div>
        ...
        <!-- <el-dialog title="真的要执行交易吗" :visible.sync="buyDialogVisible" width="50%" @close="buyDialogClosed">
            <el-button @click="buyDialogVisible = false">放弃</el-button>
            <el-button type="primary" @click="buySure">确认购买</el-button>
        </el-dialog> -->
    </div>
</template>
